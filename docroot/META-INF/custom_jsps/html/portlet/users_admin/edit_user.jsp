...
for(String mainItem : miscellaneousSections){
	if(mainItem.equalsIgnoreCase("display-settings")){
		mainList.add("custom-user-data");
	}
  mainList.add(mainItem);
   //System.out.println(mainItem);
}
		//mainList.add("ringimage");
miscellaneousSections = new String[mainList.size()];
for(int i = 0; i < mainList.size(); i++){
	miscellaneousSections[i] =mainList.get(i);
}
//Prodyna }
